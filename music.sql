...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2025 at 03:58 PM
...
(27, 2, 21, 1, 0, '2025-09-12 11:55:58', '2025-09-12 11:55:58'),
(28, 1, 22, 1, 0, '2025-09-19 05:34:40', '2025-09-19 05:34:40');
...
(6, 21, 4, 'Post', 1, 0, '2025-09-12 12:40:52', '2025-09-12 12:40:52'),
(7, 21, 2, 'Nice Song !', 1, 0, '2025-09-18 12:02:45', '2025-09-18 12:02:45');
...
(1, 'PlayList 2022', 'etbhauehb suh f  etbhauehb suh f  etbhauehb suh f ', '1757064646527-consert3.jpg', 1, 1, 0, '2025-09-05 09:30:46', '2025-09-15 12:49:00'),
(2, 'PlayList 2024', 'etbhauehb suh f  etbhauehb suh f  etbhauehb suh f ', '1757064646527-consert3.jpg', 2, 1, 0, '2025-09-05 09:36:45', '2025-09-15 12:52:10');
...
(12, 21, 4, 1, 0, '2025-09-12 12:23:13', '2025-09-12 12:23:13'),
(13, 19, 4, 1, 0, '2025-09-12 13:00:44', '2025-09-12 13:00:44'),
(14, 21, 2, 1, 0, '2025-09-16 12:11:44', '2025-09-16 12:11:44'),
(15, 21, 2, 1, 0, '2025-09-18 12:02:23', '2025-09-18 12:02:23'),
(16, 14, 2, 1, 0, '2025-09-18 13:11:49', '2025-09-18 13:11:49');
...
(1, 1, 'Sad Songs PlayList', '1755620628083-ada621f9-f8e7-44a9-90a1-3497c0a1a5e7.jpg', 1, 0, '2025-08-19 16:23:48', '2025-08-19 16:23:48'),
...
(6, 3, 21, 1, 0, '2025-09-15 09:37:46', '2025-09-15 09:37:46'),
(7, 3, 19, 1, 0, '2025-09-15 09:38:06', '2025-09-15 09:38:06'),
(8, 3, 20, 1, 0, '2025-09-15 09:38:57', '2025-09-15 09:38:57');
...
--
-- Dumping data for table `tbl_podcast`
--

INSERT INTO `tbl_podcast` (`id`, `title`, `taken_by`, `description`, `duration`, `video`, `thumbnail`, `total_likes`, `total_views`, `total_comments`, `is_active`, `is_deleted`, `created_at`, `updated_at`) VALUES
(1, 'Sherya Ghosle', 'Lilly Singh', 'Lilly SinghSat down with the incredible Shreya Ghoshal to dive deep into the world behind Bollywood\'s biggest hits! We talked about the hidden challenges, the impact of item songs, and why it\'s so important for women to have a voice in music and finances. A literal queen! ', 1708, '1758031722055-shreya-ghoshal-whats-really-happening-behind-bollywood-music.mp4', '1758031723475-podcastImg.webp', 0, 0, 0, 1, 0, '2025-09-16 14:08:43', '2025-09-16 14:08:43');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_podcast_comments`
--

CREATE TABLE `tbl_podcast_comments` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `tbl_podcast_likes`
--

CREATE TABLE `tbl_podcast_likes` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `podcast_id` bigint(20) NOT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
...
--
-- Dumping data for table `tbl_song_story`
--

INSERT INTO `tbl_song_story` (`id`, `title`, `admin_id`, `description`, `star_name`, `is_active`, `is_deleted`, `created_at`, `updated_at`) VALUES
(1, 'Impedit necessitati', 1, 'Magnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididun', 'Adele Armstrong123', 1, 0, '2025-09-17 12:12:25', '2025-09-17 12:12:25'),
(2, 'Necessitatibus et en', 1, 'Omnis sequi tenetur \nMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididun', 'Hilary Hays', 1, 0, '2025-09-17 12:13:07', '2025-09-17 12:13:07'),
(3, 'Ut dicta veritatis v', 1, 'Nobis autem reprehen\n\nMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididun', 'Orson Nichols', 1, 0, '2025-09-17 12:13:16', '2025-09-17 12:13:16'),
(4, 'Mollit et doloribus ', 1, 'Labore nulla aut eiu\n\nMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididunMagnam aut incididun', 'Maxine Todd', 1, 0, '2025-09-17 12:13:29', '2025-09-17 12:13:29'),
(5, 'Rerum ipsa pariatur', 1, 'Rem lorem dolor veniRem lorem dolor veniRem lorem dolor veniRem lorem dolor veniRem lorem dolor veniRem lorem dolor veni', 'Julie Rutledge', 1, 0, '2025-09-17 12:13:48', '2025-09-17 12:13:48');
...
(82, 'kk', 21, 1, 0, '2025-09-12 11:55:58', '2025-09-12 11:55:58'),
(83, 'jannat', 21, 1, 0, '2025-09-12 11:55:58', '2025-09-12 11:55:58'),
(84, 'HaanTuHai', 21, 1, 0, '2025-09-12 11:55:58', '2025-09-12 11:55:58'),
(85, 'atif', 22, 1, 0, '2025-09-19 05:34:40', '2025-09-19 05:34:40'),
(86, 'atifaslam', 22, 1, 0, '2025-09-19 05:34:40', '2025-09-19 05:34:40');
...
--
-- Table structure for table `tbl_user_listens`
--

CREATE TABLE `tbl_user_listens` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `song_id` bigint(20) DEFAULT NULL,
  `podcast_id` bigint(20) DEFAULT NULL,
  `listened_seconds` int(11) DEFAULT 0,
  `last_listened_at` timestamp NOT NULL DEFAULT current_timestamp()
) ;
...
--
-- Indexes for table `tbl_podcast_comments`
--
ALTER TABLE `tbl_podcast_comments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tbl_podcast_likes`
--
ALTER TABLE `tbl_podcast_likes`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_song_story`
--
ALTER TABLE `tbl_song_story`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tbl_user_listens`
--
ALTER TABLE `tbl_user_listens`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_podcast_comments`
--
ALTER TABLE `tbl_podcast_comments`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_podcast_likes`
--
ALTER TABLE `tbl_podcast_likes`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tbl_song_story`
--
ALTER TABLE `tbl_song_story`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `tbl_user_listens`
--
ALTER TABLE `tbl_user_listens`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
COMMIT;
